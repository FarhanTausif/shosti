...
//                   <div className="space-y-2">
//                     <Label htmlFor="bmdcRegNo" className="text-slate-700">BMDC Registration</Label>
//                     <Input
//                       type="text"
//                       name="bmdcRegNo"
//                       onChange={handleChange}
...
export default function MHPSignup() {
  ...
  // Form state for MHP registration
  const [formData, setFormData] = useState({
    username: "",
    bmdcRegNo: "",
    email: "",
  ...
  // Handle form submission for MHP signup
  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsSubmitting(true);
    try {
      ...
      // NEW: On successful registration, the MHP's status is "pending" by default.
