...
// Components/dashboard/attendee/Resource.jsx
// "use client";
// import React, { useEffect, useState } from "react";
...
//           <option value="Mindfulness Exercises and Meditation">
...
//           <option value="Workplace Mental Health">Workplace Mental Health</option>
//         </select>
//       </div>
//       {resources.length ? (
//         <div className="space-y-4">
        ...
        <div className="space-y-4">
          {resources.map((resource) => (
            <div key={resource._id} className="p-4 border rounded-md shadow-sm">
              ...
              {resource.mhpName && (
                <p className="text-sm text-gray-600">Added by: {resource.mhpName}</p>
              )}
              <p className="text-sm text-gray-500">
                Categories: {resource.categories.join(", ")}
              </p>
